...
<Head
	title="עיצוב תכשיטים אישי אונליין | ברבי עיצובים – טבריה, צפון ישראל"
	description="עצבי תכשיט ייחודי בהתאמה אישית עם המעצבת האינטראקטיבית של ברבי עיצובים בטבריה. בחרי תבנית, התאימי רכיבים ויצרי צמיד או תכשיט מושלם – בסטודיו בצפון ישראל."
	canonical="https://barbracha.vercel.app/customjewelry"
	openGraph={{
		title: 'עיצוב תכשיטים אישי אונליין | ברבי עיצובים – טבריה, צפון ישראל',
		description:
			'עצבי תכשיט ייחודי בהתאמה אישית – בחרי תבנית, התאימי רכיבים ויצרי צמיד מושלם. מעצבת התכשיטים האינטראקטיבית של ברבי עיצובים, סטודיו בטבריה, צפון ישראל.',
		url: 'https://barbracha.vercel.app/customjewelry',
		...
		image: {
			...
			width: 1080,
			height: 1080,
			alt: 'מעצבת תכשיטים אישית אונליין – ברבי עיצובים טבריה צפון ישראל'
		}
	}}
/>
