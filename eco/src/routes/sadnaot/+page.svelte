...
<Head
	title="סדנת עיצוב תכשיטים אישי בטבריה | ברבי עיצובים – צפון ישראל"
	description="הצטרפי לסדנת עיצוב תכשיטים אישי בטבריה עם נוף פנורמי לכינרת. למדי ליצור תכשיט בהתאמה אישית בעבודת יד בסטודיו של ברבי, צפון ישראל. תאמי מפגש עוד היום!"
	canonical="https://barbracha.vercel.app/sadnaot"
	openGraph={{
		title: 'סדנת עיצוב תכשיטים אישי בטבריה | ברבי עיצובים – צפון ישראל',
		description:
			'סדנת יצירת תכשיטים בהתאמה אישית בטבריה, עם נוף מרהיב לכינרת. שלבי טכניקות מסורתיות וחדשניות בסטודיו של ברבי בצפון ישראל.',
		...
		image: {
			...
			width: 1080,
			height: 1080,
			alt: 'סדנת עיצוב תכשיטים בטבריה עם נוף לכינרת – ברבי עיצובים צפון ישראל'
		}
	}}
/>
	...
	>
		<Drawer.Root bind:open={dialogOpen} shouldScaleBackground>
			<div class="text-center -mt-44">
				...
				<p
					class="sm:px-28 text-2xl mb-6 bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] text-transparent bg-clip-text font-[MakabiYG]"
				>
					ברבי מזמינה אותך ליצירת תכשיט בהתאמה אישית <br /> בסטודיו עם נוף פנורמי מרהיב לכינרת, תגלי
					את הקסם שבעיצוב תכשיטים בעבודת יד, תוך שילוב של טכניקות מסורתיות וחדשניות ומיומנויות מקצועיות.
				</p>
				<h2
					class="text-3xl font-[MakabiYG] mb-4 bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] text-transparent bg-clip-text sparkly-uv pearl-effect"
				>
					?איך יוצרות תכשיט בעיצוב אישי
				</h2>
			...
			<div class="flex flex-col items-center justify-center align-middle pb-2 mb-2 nod w-full">
				<button
					...
					class="p-2 mb-2 focus:outline-none bg-transparent hover:bg-transparent"
				>
					<div class="heart-container relative w-full h-[300px] max-w-[400px] -mb-20">
						<span
							class="absolute top-8 left-1/2 transform -translate-x-1/2 text-4xl font-extrabold font-[MakabiYG] bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] text-transparent bg-clip-text"
							>להזמנה</span
						>
